...
Object.defineProperty(exports, "convertHexToRgba", {
  enumerable: true,
  get: function () {
    return _convertHexToRgba.default;
  }
});
...
exports.getTokens = exports.fromPlainObject = void 0;
...
const getTokens = customFoundation => {
  ...
  const theme = customFoundation ? (0, _mergeDeepRight.default)(_foundation.default, customFoundation) : _foundation.default;
  return {
    // category:Colors
    ...
    backgroundTableShadowLeft: "linear-gradient(to left, transparent, ".concat((0, _convertHexToRgba.default)(theme.palette.cloud.darker, 23), ")"),
    backgroundTableShadowRight: "linear-gradient(to right, transparent, ".concat((0, _convertHexToRgba.default)(theme.palette.cloud.darker, 23), ")"),
