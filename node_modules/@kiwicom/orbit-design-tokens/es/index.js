...
export const getTokens = customFoundation => {
  ...
  return {
    ...
    backgroundTableShadowLeft: "linear-gradient(to left, transparent, ".concat(convertHexToRgba(theme.palette.cloud.darker, 23), ")"),
    backgroundTableShadowRight: "linear-gradient(to right, transparent, ".concat(convertHexToRgba(theme.palette.cloud.darker, 23), ")"),
    ...
    paddingTag: "".concat(theme.base.spaceXs),
    ...
    // category:Box shadow
    // description:
    boxShadowButtonFocus: "0 0 4px 1px ".concat(convertHexToRgba(theme.palette.blue.normal, 30)),
    boxShadowAction: "0px 0px 2px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px 1px 4px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 12)),
    boxShadowActionActive: "0px 1px 4px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px 4px 8px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 12)),
    boxShadowFixed: "0px 0px 2px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px 2px 4px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 12)),
    boxShadowFixedReverse: "0px 0px 2px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px -2px 4px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 12)),
    boxShadowRaised: "0px 4px 8px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px 8px 24px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 24)),
    boxShadowRaisedReverse: "0px -4px 8px 0px ".concat(convertHexToRgba(theme.palette.ink.normal, 16), ", 0px -8px 24px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 24)),
    boxShadowOverlay: "0px 12px 24px -4px ".concat(convertHexToRgba(theme.palette.ink.normal, 24), ", 0px 8px 60px 0px ").concat(convertHexToRgba(theme.palette.ink.normal, 32)),
