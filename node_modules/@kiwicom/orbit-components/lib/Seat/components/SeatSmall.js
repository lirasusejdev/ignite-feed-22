...
const StyledPath = _styledComponents.default.path.withConfig({
  displayName: "SeatSmall__StyledPath",
  componentId: "sc-1i27h5c-0"
...
const StyledStrokeSmall = _styledComponents.default.path.withConfig({
  displayName: "SeatSmall__StyledStrokeSmall",
  componentId: "sc-1i27h5c-1"
})(["transition:stroke ", " ease-in;"], ({
  theme
}) => theme.orbit.durationFast); // $FlowFixMe: https://github.com/flow-typed/flow-typed/issues/3653#issuecomment-568539198
