...
const StyledCircleWrapper = _styledComponents.default.div.withConfig({
  displayName: "SeatCircle__StyledCircleWrapper",
  componentId: "sc-18ztlni-0"
})(["position:absolute;top:-10px;right:-10px;"]);

const StyledCirclePath = _styledComponents.default.path.withConfig({
  displayName: "SeatCircle__StyledCirclePath",
  componentId: "sc-18ztlni-1"
})([""]);
